<?php
	$title = "Alex Beals | ShiftCycle";
	include('../../php/header.php');
?>
	<div class="content">
		<article>
			<h3>ShiftCycle | August 2015</h3>
			<h4>Objective-C</h4>
			<a class="live" href="//cydia.alexbeals.com/ShiftCycle">&#xf0c1;</a>
			<a class="github" href="//github.com/dado3212/ShiftCycle">&#xf09b;</a>
			<p>
				ShiftCycle is a tweak for iPhones that makes it so when you tap 'Shift' with text selected it cycles it through a variety of toggleable options.<br>
