...
<body>
	<div class="content">
		<article>
			...
			<p>
				I originally worked on a this project with another developer using Joomla as our CMS platform, along with our own custom PHP backend for administration and controlling content/available packs/sales and coupons.  However, it became quickly apparent that Joomla was both too much in some areas, and too little in others, so we overhauled this project over the last year to build our own custom solution.
			</p>
			<div class="image">
				<img src="ThePackMarketNew.png"/>
